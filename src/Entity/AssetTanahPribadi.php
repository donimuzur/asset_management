...
/**
 * @ORM\Entity(repositoryClass=AssetTanahPribadiRepository::class)
 */
class AssetTanahPribadi
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @return Collection|AttachmentAssetTanahPribadi[]
     */
    ...
    public function addAttachment(AttachmentAssetTanahPribadi $attachment): self
    {
        if (!$this->Attachment->contains($attachment)) {
            $this->Attachment[] = $attachment;
            $attachment->setAssetTanahPribadi($this);
        }

        return $this;
    }

    public function removeAttachment(AttachmentAssetTanahPribadi $attachment): self
    {
