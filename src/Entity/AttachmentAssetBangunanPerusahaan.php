...
use App\Repository\AttachmentAssetBangunanPerusahaanRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=AttachmentAssetBangunanPerusahaanRepository::class)
 */
class AttachmentAssetBangunanPerusahaan
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
...
/**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetUser::class, inversedBy="attachmentAssetBangunanPerusahaans")
     */
    private $attached_by;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetBangunanPerusahaan::class, inversedBy="Attachment")
