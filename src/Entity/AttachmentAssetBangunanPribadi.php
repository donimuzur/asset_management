...
use App\Repository\AttachmentAssetBangunanPribadiRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=AttachmentAssetBangunanPribadiRepository::class)
 */
class AttachmentAssetBangunanPribadi
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
...
/**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetUser::class, inversedBy="attachmentAssetBangunanPribadis")
     */
    private $attached_by;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetBangunanPribadi::class, inversedBy="Attachment")
