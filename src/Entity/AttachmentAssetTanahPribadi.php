...
use App\Repository\AttachmentAssetTanahPribadiRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=AttachmentAssetTanahPribadiRepository::class)
 */
class AttachmentAssetTanahPribadi
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
...
/**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetUser::class, inversedBy="attachmentAssetTanahPribadis")
     */
    private $attached_by;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetTanahPribadi::class, inversedBy="Attachment")
