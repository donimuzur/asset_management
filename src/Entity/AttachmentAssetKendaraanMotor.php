...
/**
 * @ORM\Entity(repositoryClass=AttachmentAssetKendaraanMotorRepository::class)
 */
class AttachmentAssetKendaraanMotor
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetUser::class, inversedBy="attachmentAssetKendaraanMotors")
     */
    private $attached_by;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetKendaraanMotor::class, inversedBy="Attachment")
     * @ORM\JoinColumn(nullable=false)
     */
    private $assetKendaraanMotor;
    ...
    public function getAssetKendaraanMotor(): ?AssetKendaraanMotor
    {
        return $this->assetKendaraanMotor;
    }

    public function setAssetKendaraanMotor(?AssetKendaraanMotor $assetKendaraanMotor): self
    {
        $this->assetKendaraanMotor = $assetKendaraanMotor;
