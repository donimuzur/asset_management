...
use App\Repository\AttachmentAssetKendaraanMobilRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=AttachmentAssetKendaraanMobilRepository::class)
 */
class AttachmentAssetKendaraanMobil
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetUser::class, inversedBy="attachmentAssetKendaraanMobils")
     */
    private $attached_by;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AssetKendaraanMobil::class, inversedBy="Attachment")
     * @ORM\JoinColumn(nullable=false)
     */
    private $assetKendaraanMobil;
    ...
    public function getAssetKendaraanMobil(): ?AssetKendaraanMobil
    {
        return $this->assetKendaraanMobil;
    }

    public function setAssetKendaraanMobil(?AssetKendaraanMobil $assetKendaraanMobil): self
    {
        $this->assetKendaraanMobil = $assetKendaraanMobil;
