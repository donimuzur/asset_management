                    ...
                    },
                    {
                        ...
                        value: function () {
                            jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.cb.helpers.core", function (e) {
                                ...
                                t.addClass("js-scroll-to-enabled"), jQuery("html, body").animate({ scrollTop: jQuery(n).offset().top - r }, o);
                            });
                        },
                    },
                    {
                                ...
                                t.addClass("js-click-ripple-enabled")
                                    ...
                                    .on("click.cb.helpers.core", function (e) {
                                        ...
                                        0 === t.children(".click-ripple").length ? t.prepend('<span class="click-ripple"></span>') : t.children(".click-ripple").removeClass("animate"),
                                            (a = t.children(".click-ripple")).height() || a.width() || ((n = Math.max(t.outerWidth(), t.outerHeight())), a.css({ height: n, width: n })),
                                            (o = e.pageX - t.offset().left - a.width() / 2),
                                            (r = e.pageY - t.offset().top - a.height() / 2),
                                            a.css({ top: r + "px", left: o + "px" }).addClass("animate");
                                    });
                            });
                        },
                    },
                        ...
                        value: function () {
                            jQuery(".js-table-sections:not(.js-table-sections-enabled)").each(function (e, a) {
                                ...
                                t.addClass("js-table-sections-enabled"),
                                    jQuery(".js-table-sections-header > tr", t).on("click.cb.helpers", function (e) {
                                        if (
                                            !(
                        ...
                        value: function () {
                            ...
                            jQuery(".js-table-checkable:not(.js-table-checkable-enabled)").each(function (a, t) {
                                ...
                                n.addClass("js-table-checkable-enabled"),
                                    jQuery("thead input:checkbox", n).on("click.cb.helpers", function (a) {
                                    ...
                                    jQuery("tbody input:checkbox, tbody input + label", n).on("click.cb.helpers", function (a) {
                                        ...
                                        t.prop("checked")
                                            ? jQuery("tbody input:checkbox:checked", n).length === jQuery("tbody input:checkbox", n).length && jQuery("thead input:checkbox", n).prop("checked", !0)
                            ...
                            jQuery(".js-draggable-items:not(.js-draggable-items-enabled)").each(function (e, a) {
                                jQuery(a)
                                    ...
                                    .sortable({
                                        ...
                                        tolerance: "pointer",
                                        start: function (e, a) {
                                            a.placeholder.css({ height: a.item.outerHeight(), "margin-bottom": a.item.css("margin-bottom") });
                                        },
                                    });
                            });
                        },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            jQuery(window).off("resize.cb.main orientationchange.cb.main"),
                                a._lMain.length &&
                                    jQuery(window)
                                        .on("resize.cb.main orientationchange.cb.main", function (t) {
                                            clearTimeout(e),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            e._lPage.off("click.cb.menu"),
                                e._lPage.on("click.cb.menu", '[data-toggle="nav-submenu"]', function (a) {
                                    var t = jQuery(a.currentTarget),
                                        n = t.parent("li");
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]')
                                ...
                                this._lPage.on("click.cb.themes", '[data-toggle="theme"]', function (t) {
                                    t.preventDefault();
                            ...
                            var t = {
                                init: function () {
                                    a._lPage.off("click.cb.layout"),
                                        ...
                                        a._lPage.on("click.cb.layout", '[data-toggle="layout"]', function (e) {
                        ...
                        value: function () {
                                ...
                                u = {
                                    init: function () {
                                        jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]').each(function (e, a) {
                                            ...
                                            l._lPage.on("click.cb.blocks", '[data-toggle="block-option"]', function (e) {
                            ...
                            "init" === r
                                ...
                                : (e = o instanceof jQuery ? o : jQuery(o)).length &&
                                  ((a = jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]', e)), (t = jQuery('[data-toggle="block-option"][data-action="content_toggle"]', e)), u[r] && u[r]());
                        },
                    },
                    {
                        key: "init",
        ...
        var g = (function (e) {
            ...
            return (
                (function (e, a) {
                    ...
                    (e.prototype = Object.create(a && a.prototype, { constructor: { value: e, writable: !0, configurable: !0 } })), a && h(e, a);
                })(a, s),
                a
            );
        })();
